...
class CodegaAiDesktopCleanStartTests(unittest.TestCase):
    def test_windows_desktop_app_is_isolated_from_legacy_python_stack(self):
        ...
        self.assertIn('"version": "4.5.14"', package)
    ...
    def test_desktop_release_hardening_for_av_reputation(self):
        ...
        self.assertIn('"dist:mac": "electron-builder --mac dmg zip --x64 --arm64 --publish never"', package)
        self.assertIn('"release:mac": "electron-builder --mac dmg zip --x64 --arm64 --publish always"', package)
    ...
    def test_ai_layer_has_instant_and_ollama_providers(self):
        ...
        self.assertIn("const OLLAMA_CHAT_TIMEOUT_MS = 30 * 1000", constants)
