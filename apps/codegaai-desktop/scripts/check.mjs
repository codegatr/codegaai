...
if (!plannerAgent.includes("planTask") || !plannerAgent.includes("TASK-001") || !plannerAgent.includes("Veritabanı Şeması")) throw new Error("Desktop Phoenix Planner Agent is incomplete");
